...
class CCDCRepository {
  final String _view = "VTS_CCDC";
  final String _name = "TTS_CCDC";
  ...
  Future<int> add(int itemID, dynamic giaMua) async {
    return await _cnn.addMap(_name, {'ItemID': itemID, 'GiaTri': giaMua});
  }

  Future<bool> updateMaHH(int id, int itemID, dynamic gia) async {
    return await _cnn.updateMap(_name, {'ItemID': itemID, 'GiaTri': gia}, where: 'ID = $id');
  }
