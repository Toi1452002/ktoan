...
import 'package:pm_ketoan/views/phieuchi/component/phieuchi_component.dart';
import 'package:pm_ketoan/views/phieuchi/component/phieuchi_table.dart';
import 'package:pm_ketoan/views/phieuchi/function/phieuchi_function.dart';
...
class PhieuChiView extends ConsumerStatefulWidget {
  const PhieuChiView({super.key});

  static const name = 'Phiếu chi';

  static void show(BuildContext context) {
    showCustomDialog(context, title: name.toUpperCase(), width: 500, height: 650, child: PhieuChiView());
  }
              ...
              children: [
                OutlinedContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      WidgetTableRow(
                        columnWidths: {0: FixedColumnWidth(110), 2: FixedColumnWidth(90)},
                        items: [
                      ...
                      WidgetTableRow(
                        columnWidths: {0: FixedColumnWidth(110), 2: FixedColumnWidth(50), 4: FixedColumnWidth(50)},
                        items: [
                          Text('Số tiền').medium,
                          WidgetTextField(
                            enabled: !state.Khoa,
