...
import 'package:pm_ketoan/views/khachhang/function/thongtinkhachhang_function.dart';
import 'package:pm_ketoan/widgets/combobox.dart';
import 'package:pm_ketoan/widgets/dialog_windows/dialog_funtion.dart';
import 'package:pm_ketoan/widgets/widget_table_row.dart';
        ...
        children: [
          OutlinedContainer(
            ...
            child: Column(
              ...
              children: [
                WidgetTableRow(
                  columnWidths: {0: FixedColumnWidth(120), 2: FixedColumnWidth(120)},
                  items: [
