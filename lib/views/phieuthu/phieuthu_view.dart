...
import 'package:pm_ketoan/views/phieuthu/component/phieuthu_component.dart';
import 'package:pm_ketoan/views/phieuthu/component/phieuthu_table.dart';
import 'package:pm_ketoan/views/phieuthu/function/phieuthu_function.dart';
...
class PhieuThuView extends ConsumerStatefulWidget {
  const PhieuThuView({super.key});

  static const name = "Phiếu thu";

  static void show(BuildContext context) {
    showCustomDialog(context, title: name.toUpperCase(), width: 500, height: 650, child: PhieuThuView());
  }
