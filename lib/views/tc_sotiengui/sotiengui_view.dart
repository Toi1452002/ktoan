...
import 'sotiengui_function.dart';
...
class SoTienGuiView extends ConsumerStatefulWidget {
  ...
  static const name = "Sổ tiền gửi";

  static void show(BuildContext context) =>
      showCustomDialog(context, title: name.toUpperCase(), width: 1080, height: 600, child: SoTienGuiView());
