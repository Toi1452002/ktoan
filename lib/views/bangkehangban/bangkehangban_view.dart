...
import 'package:pm_ketoan/views/bangkehangban/bangkehangban_function.dart';
    ...
    return Scaffold(
      ...
      child: DataGrid(
        ...
        columns: [
          ...
          DataGridColumn(title: ['Mã hàng', 'MaHH'], width: 100,cellColor: CellColor.red),
          ...
          DataGridColumn(title: ['Tiền chưa VAT', 'ThanhTien'], width: 130,columnType: ColumnType.num),
          DataGridColumn(title: ['Thuế', 'ThueSuat'], width: 100,columnType: ColumnType.num),
          DataGridColumn(title: ['Tiền thuế', 'TienThue'], width: 130,columnType: ColumnType.num),
          DataGridColumn(title: ['Cộng tiền', 'CongTien'], width: 130,columnType: ColumnType.num),
        ],
      ).withPadding(all: 5),
    );
  }
