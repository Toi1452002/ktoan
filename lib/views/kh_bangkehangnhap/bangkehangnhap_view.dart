...
import 'package:pm_ketoan/views/kh_bangkehangnhap/bangkehangnhap_function.dart';
...
class BangKeHangNhapView extends ConsumerStatefulWidget {
  static const name = 'Bảng kê hàng nhập';

  static void show(BuildContext context) =>
      showCustomDialog(context, title: name.toUpperCase(), width: 1050, height: 600, child: BangKeHangNhapView());
...
class _BangKeHangNhapViewState extends ConsumerState<BangKeHangNhapView> {
  ...
  final fc = BangKeHangNhapFunction();
