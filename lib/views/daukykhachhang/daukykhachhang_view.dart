...
import 'package:pm_ketoan/views/daukykhachhang/daukykhachhang_function.dart';
    ...
    return Scaffold(
      ...
      child: DataGrid(
        ...
        columns: [
          ...
          DataGridColumn(title: ['Mã khách hàng', 'MaKhach'], width: 140, cellColor: CellColor.blue),
          DataGridColumn(title: ['Tên khách hàng', 'TenKH'], width: 300,cellColor: CellColor.blue),
          DataGridColumn(title: ['Số đầu kỳ', 'SoDuNo'], width: 100, columnType: ColumnType.num, isEdit: true),
        ],
      ).withPadding(all: 5),
    );
  }
