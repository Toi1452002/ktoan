...
import 'component/thongtinhanghoa_component.dart';
import 'function/thongtinhanghoa_function.dart';
          ...
          children: [
            ...
            WidgetCustomRow(
              ...
              items: [
                ...
                WidgetIconButton(type: IconType.play,onPressed: ()=>fc.showDonViTinh(context,onGetDonViTinh),size: ButtonSize.small,),
                ...
                WidgetIconButton(type: IconType.play, onPressed: ()=>fc.showNhomHang(context, onGetNhomHang),size: ButtonSize.small),
              ],
            ),

            WidgetCustomRow(
              columnWidths: {0: 80, 1: 150, 3: 180},
              items: [
