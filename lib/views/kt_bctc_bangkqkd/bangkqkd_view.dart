...
import 'bangkqkd_function.dart';

class BangKQKDView extends ConsumerStatefulWidget {
  const BangKQKDView({super.key});

  static const name = "Báo cáo KQKD";
  static const title = "Báo cáo kết quả kinh doanh";

  static void show(BuildContext context) =>
      showCustomDialog(context, title: title.toUpperCase(), width: 1000, height: 600, child: BangKQKDView());

  @override
  ConsumerState createState() => _BangKQKDViewState();
}

class _BangKQKDViewState extends ConsumerState<BangKQKDView> {
  final fc = BangKQKDFunction();
