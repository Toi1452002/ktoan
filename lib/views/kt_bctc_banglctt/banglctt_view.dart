import 'package:pm_ketoan/views/kt_bctc_banglctt/banglctt_function.dart';
...
class BangLCTTView extends ConsumerStatefulWidget {
  const BangLCTTView({super.key});

  static const name = "Báo cáo LCTT";
  static const title = "Báo cáo lưu chuyển tiền tệ";

  static void show(BuildContext context) =>
      showCustomDialog(context, title: title.toUpperCase(), width: 1000, height: 600, child: BangLCTTView());
  @override
  ConsumerState createState() => _BangLCTTViewState();
}

class _BangLCTTViewState extends ConsumerState<BangLCTTView> {
  final fc = BangLCTTFunction();
    ...
    return Scaffold(
      ...
      child: DataGrid(
        ...
        columns: [
          ...
          DataGridColumn(title: ['Chỉ tiêu', 'ChiTieu'], width: 450, textStyle: ColumnTextStyle.blue()),
          DataGridColumn(
            title: ['Mã số', 'MaSo'],
            width: 70,
          ...
          DataGridColumn(title: ['Thuyết minh', 'ThuyetMinh'], width: 150,isEdit: true),
          DataGridColumn(
