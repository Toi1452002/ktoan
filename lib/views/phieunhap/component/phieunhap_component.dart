...
class PhieuNhapComponent {
  DateTextbox ngayXuat({required void Function(DateTime?) onChanged, DateTime? initialDate, bool enabled = true}) {
    return DateTextbox(onChanged: onChanged, showClear: false, initialDate: initialDate, enabled: enabled);
  }
